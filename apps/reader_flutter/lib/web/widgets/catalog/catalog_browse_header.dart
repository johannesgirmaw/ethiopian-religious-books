...
class WebCatalogBrowseHeader extends StatefulWidget {
  const WebCatalogBrowseHeader({
    super.key,
  ...
  @override
  State<WebCatalogBrowseHeader> createState() => _WebCatalogBrowseHeaderState();
}

class _WebCatalogBrowseHeaderState extends State<WebCatalogBrowseHeader> {
  ...
  Widget build(BuildContext context) {
    ...
    final horizontal = webPageHorizontal(context);

    if (tier == AppLayoutTier.expanded) {
      return Padding(
